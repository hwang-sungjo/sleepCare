...
/**
 * Bedrock Converse {@link Tool} 정의 —
 * {@link docs/02-chatbot-skills-openapi.json} 과 동일 operationId.
 */
public final class ChatbotToolSpecFactory {
         ...
         * {@link Document#fromString(String)}은 JSON 스키마 문자열을 파싱하지 않고 문자열 스칼라로 보내 400이
         * 납니다.
         */
