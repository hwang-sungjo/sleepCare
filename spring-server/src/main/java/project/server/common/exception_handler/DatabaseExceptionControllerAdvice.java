...
import static project.server.common.response.status.BaseExceptionResponseStatus.BAD_SQL_GRAMMAR;
import static project.server.common.response.status.BaseExceptionResponseStatus.DATABASE_ERROR;
